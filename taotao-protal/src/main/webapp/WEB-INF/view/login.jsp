...
<form id="formlogin" method="post" onsubmit="return false;">
    ...
    <div class=" w1" id="entry">
        ...
        <div class="free-regist">
            <span><a href="http://www.taotao.com/page/register.shtml" clstag="passport|keycount|login|08">免费注册&gt;&gt;</a></span>
        </div>
    </div>
</form>
<div class="w1">
...
<script>
   ...
   $("#loginsubmit").click(function () {
	    ...
	    if (flag) {
	        ...
	        $.ajax({
	            type: "POST",
	            url: "/user/doLogin.shtml?r=" + Math.random(),
	            ...
	            success: function (result) {
	                if (result) {
	                    ...
	                    if (obj.status == 200) {
                            ...
                            if(redirectUrl){
                                obj.success ="http://www.taotao.com"+redirectUrl;
                            }else {
                                //为空就跳首页
